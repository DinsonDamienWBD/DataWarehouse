...
/// <summary>
/// Active mount handle for a Linux FUSE3 mount session.
...
/// </remarks>
[SdkCompatibility("6.0.0", Notes = "Phase 87: Linux FUSE3 mount handle (VOPT-85)")]
[SupportedOSPlatform("linux")]
public sealed class Fuse3MountHandle : IMountHandle
{
    ...
    public async ValueTask DisposeAsync()
    {
        ...
        try
        {
            ...
            {
                Fuse3Native.fuse_session_exit(_fuseSession);
            }
            ...
            if (_fuseSession != IntPtr.Zero)
            {
                Fuse3Native.fuse_session_unmount(_fuseSession);
                Fuse3Native.fuse_session_destroy(_fuseSession);
            }
