...
namespace DataWarehouse.SDK.Contracts.RAID
{
    ...
    /// </summary>
    public abstract class RaidStrategyBase : IRaidStrategy
    {
        /// <inheritdoc/>
        ...
        /// <summary>
        /// Unique identifier for this RAID strategy.
        /// </summary>
        public virtual string StrategyId => $"raid-{Level.ToString().ToLowerInvariant()}";

        /// <summary>
        /// Human-readable name of this RAID strategy.
        /// </summary>
        ...
        /// </summary>
        protected virtual string GetKnowledgeTopic() => "raid";

        /// <summary>
        /// Gets the capability category for this strategy type.
        /// </summary>
        protected virtual CapabilityCategory GetCapabilityCategory() => CapabilityCategory.RAID;
        ...
        /// <summary>
        /// Requests an AI recommendation for optimal RAID configuration.
        /// </summary>
        /// <param name="workloadType">Type of workload (read-heavy, write-heavy, mixed).</param>
        /// <param name="diskCount">Number of available disks.</param>
        /// <param name="prioritizeFaultTolerance">Whether to prioritize fault tolerance over performance.</param>
        /// <param name="cancellationToken">Cancellation token.</param>
        /// <returns>Recommended RAID configuration, or null if Intelligence unavailable.</returns>
        protected async Task<Dictionary<string, object>?> RequestRaidRecommendationAsync(
            string workloadType,
            int diskCount,
            bool prioritizeFaultTolerance = false,
            CancellationToken cancellationToken = default)
        {
            ...
            {
                ["requestType"] = "raid_recommendation",
                ["strategyId"] = StrategyId,
                ["workloadType"] = workloadType,
                ["diskCount"] = diskCount,
                ["prioritizeFaultTolerance"] = prioritizeFaultTolerance,
