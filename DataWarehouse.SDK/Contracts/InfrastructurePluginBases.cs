...
namespace DataWarehouse.SDK.Contracts
{
    ...
    // CircuitBreakerOpenException moved to InfrastructureContracts.cs
    ...
    // RaidLevel, RaidArrayStatus, RebuildResult, ScrubResult moved to InfrastructureContracts.cs

    /// <summary>
    /// Health information for a single RAID provider. (Dead -- kept for dead base class compilation until Plan 02)
    /// </summary>
    ...
    // Live compliance/auth types moved to InfrastructureContracts.cs
    // Dead types below kept for dead base class compilation until Plan 02 deletes the file

    /// <summary>
    /// Result of compliance validation. (Dead -- 0 external refs)
    /// </summary>
    ...
    /// <summary>
    /// Parameters for generating compliance reports. (Dead -- 0 external refs)
    /// </summary>
    ...
    /// <summary>
    /// Entry in a compliance report. (Dead -- 0 external refs)
    /// </summary>
    ...
    // AuthenticationRequest, AuthenticationResult, TokenValidationResult, AuthorizationResult
    // moved to InfrastructureContracts.cs
