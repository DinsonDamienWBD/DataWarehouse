...
/// <summary>
/// ScyllaDB wide-column storage strategy with production-ready features:
/// - Cassandra-compatible API with higher performance
...
public sealed class ScyllaDbStorageStrategy : DatabaseStorageStrategyBase
{
    ...
    public override string Name => "ScyllaDB Wide-Column Storage";
    public override StorageTier Tier => StorageTier.Hot;
    public override DatabaseCategory DatabaseCategory => DatabaseCategory.WideColumn;
    public override string Engine => "ScyllaDB";
    ...
    {
        // Create keyspace with ScyllaDB-optimized settings
        ...
        // Create table with ScyllaDB optimizations
        await _session.ExecuteAsync(new SimpleStatement($@"
    ...
    {
        var query = $"SELECT key, size, content_type, etag, metadata, created_at, modified_at FROM {_tableName}";
