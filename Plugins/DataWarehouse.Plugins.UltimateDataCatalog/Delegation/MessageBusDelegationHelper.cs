...
namespace DataWarehouse.Plugins.UltimateDataCatalog.Delegation;

/// <summary>
/// Wraps message bus delegation calls with circuit breaker protection and local cache fallback.
/// When the authoritative plugin (e.g. UltimateDataLineage) is unavailable or slow,
...
internal sealed class MessageBusDelegationHelper : IDisposable
{
    ...
    /// <param name="targetTopic">The topic prefix for delegation (e.g. "lineage").</param>
    ...
    /// </summary>
    /// <param name="topic">The full topic to send to (e.g. "lineage.add-edge").</param>
