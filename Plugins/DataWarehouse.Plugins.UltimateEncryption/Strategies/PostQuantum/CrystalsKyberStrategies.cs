...
namespace DataWarehouse.Plugins.UltimateEncryption.Strategies.PostQuantum
{
    ...
    public sealed class KyberKem512Strategy : EncryptionStrategyBase
    {
        ...
        {
            // NOTE (finding #2992): This strategy uses NTRU-HPS-2048-509, NOT CRYSTALS-Kyber/
            // ML-KEM. NTRU and Kyber are different lattice constructions with incompatible key
            // formats. The AlgorithmName and StrategyName have been corrected to reflect the
            // actual underlying KEM. Keys generated by this strategy are NOT interoperable with
            // any CRYSTALS-Kyber or FIPS 203 ML-KEM implementation.
            ...
            Parameters = new Dictionary<string, object>
            {
                ...
                ["Note"] = "NTRU-HPS-2048-509 KEM (NOT CRYSTALS-Kyber/FIPS 203 — different lattice construction, incompatible keys)"
            }
        };
        ...
        /// <inheritdoc/>
        public override string StrategyName => "NTRU-HPS-2048-509 + AES-256-GCM (NIST Level 1, via crystals-kyber-512)";
    ...
    public sealed class KyberKem768Strategy : EncryptionStrategyBase
    {
        ...
        public override CipherInfo CipherInfo => new()
        {
            // NOTE (finding #2992): This strategy uses NTRU-HPS-2048-677, NOT CRYSTALS-Kyber/
            // ML-KEM. NTRU and Kyber are different lattice constructions with incompatible key
            // formats. The AlgorithmName and StrategyName have been corrected to reflect the
            // actual underlying KEM. Keys generated by this strategy are NOT interoperable with
            // any CRYSTALS-Kyber or FIPS 203 ML-KEM implementation.
            ...
            Parameters = new Dictionary<string, object>
            {
                ...
                ["KemImplementation"] = "BouncyCastle-NTRU",
                ["Recommended"] = true,
                ["Note"] = "NTRU-HPS-2048-677 KEM (NOT CRYSTALS-Kyber/FIPS 203 — different lattice construction, incompatible keys)"
            }
        };
        ...
        /// <inheritdoc/>
        public override string StrategyName => "NTRU-HPS-2048-677 + AES-256-GCM (NIST Level 3, Recommended, via crystals-kyber-768)";
    ...
    public sealed class KyberKem1024Strategy : EncryptionStrategyBase
    {
        ...
        public override CipherInfo CipherInfo => new()
        {
            // NOTE (finding #2992): This strategy uses NTRU-HPS-4096-821, NOT CRYSTALS-Kyber/
            // ML-KEM. NTRU and Kyber are different lattice constructions with incompatible key
            // formats. The AlgorithmName and StrategyName have been corrected to reflect the
            // actual underlying KEM. Keys generated by this strategy are NOT interoperable with
            // any CRYSTALS-Kyber or FIPS 203 ML-KEM implementation.
            ...
            Parameters = new Dictionary<string, object>
            {
                ...
                ["NistLevel"] = 5,
                ["KemImplementation"] = "BouncyCastle-NTRU",
                ["Note"] = "NTRU-HPS-4096-821 KEM (NOT CRYSTALS-Kyber/FIPS 203 — different lattice construction, incompatible keys)"
            }
        };
        ...
        /// <inheritdoc/>
        public override string StrategyName => "NTRU-HPS-4096-821 + AES-256-GCM (NIST Level 5, via crystals-kyber-1024)";
