...
namespace DataWarehouse.Plugins.UltimateKeyManagement.Strategies.IndustryFirst
{
    ...
    public sealed class StellarAnchorsStrategy : KeyStoreStrategyBase
    {
        ...
        private Server _stellarServer = null!; // Initialized in InitializeStorage before first use
        private KeyPair _masterKeyPair = null!; // Initialized in InitializeStorage before first use
