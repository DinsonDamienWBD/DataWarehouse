...
{
    /// <summary>MySQL bulk import strategy using LOAD DATA INFILE for high-performance data ingestion.</summary>
    public class MySqlImportStrategy : UltimateStorageStrategyBase
    {
        public override string StrategyId => "mysql-import";
        public override string Name => "MySQL Bulk Import";
