...
namespace DataWarehouse.Plugins.UltimateAccessControl.Strategies.Clearance
{
    ...
    public sealed class CustomClearanceFrameworkStrategy : AccessControlStrategyBase
    {
        ...
        {
            IncrementCounter("custom.clearance.framework.init");
        ...
        {
            IncrementCounter("custom.clearance.framework.shutdown");
...
/// <inheritdoc/>
        ...
        {
            IncrementCounter("custom.clearance.framework.evaluate");
