...
namespace DataWarehouse.Plugins.UltimateConnector.Strategies.IoT
{
    ...
    public class OpcUaConnectionStrategy : IoTConnectionStrategyBase
    {
        ...
        {
            // P2-2132: Use ParseHostPortSafe to correctly handle IPv6 addresses like [::1]:4840
            var (host, port) = ParseHostPortSafe(config.ConnectionString ?? throw new ArgumentException("Connection string required"), 4840);
