...
namespace DataWarehouse.Plugins.UltimateConnector.Strategies.NoSql
{
    ...
    public class ElasticsearchConnectionStrategy : DatabaseConnectionStrategyBase
    {
        ...
        /// <summary>
        /// Executes a search query against Elasticsearch using the REST API.
            ...
            IConnectionHandle handle, string query, Dictionary<string, object?>? parameters = null, CancellationToken ct = default)
        {
            if (_httpClient == null)
            {
                return new List<Dictionary<string, object?>>
                {
                    new()
                    {
                        ...
                        ["__message"] = "Elasticsearch connection not established.",
                ...
                if (!response.IsSuccessStatusCode)
                {
                    ...
                    return new List<Dictionary<string, object?>>
                    {
                        new()
                        {
                            ...
                            ["__message"] = $"Elasticsearch query failed: {response.StatusCode}",
                            ["__error"] = errorBody,
                            ["__strategy"] = StrategyId
                        }
                    };
            ...
            catch (Exception ex)
            {
                return new List<Dictionary<string, object?>>
                {
                    ...
                    {
                        ["__status"] = "ERROR",
                        ["__message"] = $"Elasticsearch query error: {ex.Message}",
                        ["__strategy"] = StrategyId
                    }
                };
            }
        ...
        /// <summary>
        /// Executes a bulk or index command against Elasticsearch.
        /// </summary>
        ...
        /// <summary>
        /// Retrieves schema information from Elasticsearch by listing indices and their mappings.
        /// </summary>
