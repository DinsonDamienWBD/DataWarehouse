...
must_haves:
  truths:
    - "Unit tests for key management SDK extensions pass"
    - "Envelope mode integration tests verify WrapKey/UnwrapKey roundtrip"
    - "Envelope mode benchmarks compare Direct vs Envelope performance"
    - "TamperProof encryption integration tests pass"
    - "All T94 items in TODO.md are marked [x]"
  artifacts:
