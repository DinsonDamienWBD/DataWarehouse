...
must_haves:
  truths:
    - "All B8 integrity strategies verify data tamper-evidence using cryptographic checksums"
    - "All B9 data protection strategies mask, tokenize, and anonymize data with reversible/irreversible transforms"
    - "All B10 military security strategies enforce classification levels (TS/S/C/U)"
    - "All B11 network security strategies implement firewall/WAF/IPS/DDoS/VPN/SD-WAN"
    - "All 26 strategy classes compile with zero forbidden patterns"
...
5. Update Metadata/TODO.md:
   - Mark T95.B8.1-B8.7 as [x]
   - Mark T95.B9.1-B9.7 as [x]
   - Mark T95.B10.1-B10.6 as [x]
   - Mark T95.B11.1-B11.6 as [x]
  </action>
  <verify>
