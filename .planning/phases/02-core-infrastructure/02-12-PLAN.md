...
must_haves:
  truths:
    - "Old compression plugin configurations can be read and converted to UltimateCompression format without data loss"
    - "Deprecation notices (XML doc comments with [Obsolete] or equivalent) exist on old compression plugin entry points directing users to UltimateCompression"
    - "Backward compatibility: existing code using old compression plugin APIs continues to work during transition period"
    - "UltimateCompression .csproj references ONLY DataWarehouse.SDK -- no inter-plugin project references"
    - "All 50+ compression strategies compile, have zero NotImplementedException, and zero simulation/placeholder code"
...
Purpose: Migration ensures the UltimateCompression plugin fully replaces old standalone compression plugins. Plugin isolation is verified. NOTE: "Migration complete" means functional absorption, deprecation notices, and backward compatibility -- NOT file deletion (deferred to Phase 18).
...
@Metadata/TODO.md
@.planning/phases/02-core-infrastructure/02-11-SUMMARY.md
</context>
...
<task type="auto">
  ...
  <action>
    ...
    IMPORTANT: D4 (Remove deprecated plugins) is deferred to Phase 18 (Plugin Deprecation & File Cleanup). Mark as [ ] in TODO.md with a note "Deferred to Phase 18".
  </action>
  <verify>
...
<task type="auto">
  ...
  <action>
    ...
    4. Update TODO.md for all remaining T92.D items. Mark D4 as [ ] with note "Deferred to Phase 18".
  ...
  <done>
    All T92 (UltimateCompression) items verified and updated in TODO.md. Plugin is fully production-ready with 50+ compression strategies. Full solution builds cleanly. Migration = functional absorption + deprecation, not file deletion.
  </done>
</task>
...
<success_criteria>
UltimateCompression migration means: (1) all old compression plugin functionality is absorbed, (2) deprecation notices direct users to UltimateCompression, (3) backward compatibility maintained for transition period, (4) SDK-only dependency verified. Actual file deletion deferred to Phase 18. All 50+ compression strategies are production-ready. All T92 items in TODO.md are accurate.
</success_criteria>
