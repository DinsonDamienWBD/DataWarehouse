...
- **Phase 26 in-memory implementations**: DEFERRED — revisit RaftConsensusEngine placement and Phase 26 in-memory implementation strategy separately after this discussion.
...
- **Phase 26 in-memory implementations review**: RaftConsensusEngine placement in SDK vs plugin. Revisit whether Phase 26 in-memory implementations should remain in SDK or be migrated to plugins. User wants to discuss this separately.
