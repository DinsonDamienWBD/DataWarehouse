...
Stored in Superblock Block 2 (Extended Metadata), within the 2160B free space after existing extended metadata fields. Block 1 is fully consumed by 127 Region Pointer slots (127 × 32 = 4064 bytes + 16B trailer = 4080B), leaving no room for the descriptor without a block-boundary crossing that would corrupt the Universal Block Trailer.
